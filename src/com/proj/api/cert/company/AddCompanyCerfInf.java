...
import com.proj.api.cert.student.AddStudentCertInf;
 ...
 */
public class AddCompanyCerfInf {
    public AddCompanyCerfInf(String login_id,String user_id, int cert_status, String co_name, String co_nickname, int industry_type, int co_type, String org_code, String biz_code, String org_pic, String biz_pic, int co_scale, String co_desc, String contact_person, String contact_phone, String contact_mail, String co_site, String[] co_pic_array, int co_city, String co_addr, String check_code)
            throws RelationalDatabaseException, UserNotAuthorizedException, UserDisableException, NonRelationalDatabaseException, MalformedJsonException, InvalidCheckCodeException, InvalidBackstageOperationException, InvalidOperationException, InvalidCertTypeException, UserNotExistException, UserCertAlreadyExistException {
        ...
        rConn.doSQL("INSERT INTO COMPANY_INF (UUID,STATUS,CO_NAME,CO_NICKNAME," +
                ...
                "VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ", new Object[]{user_id, cert_status, co_name, co_nickname,
